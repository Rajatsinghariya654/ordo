...
**[https://ordo-production-8254.up.railway.app](https://ordo-production-8254.up.railway.app)**

Deployed on Railway with a live MySQL database. Try it out:

| Role | Email | Password |
|---|---|---|
| Admin | `adminforordo@gmail.com` | `admin@123` |
| Personal | `sonusharma@gmail.com` | *(set during testing)* |

> Note: This is a demo deployment for presentation purposes and may be paused after review.
